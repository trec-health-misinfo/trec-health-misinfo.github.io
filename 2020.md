...
## Tentative Schedule
* **~~June 30, 2020~~ ~~July 17, 2020~~** [Topics are released](https://trec.nist.gov/data/misinfo/2020resources.tar.gz)
...
The topics can be found in the resources tar file (located [here](https://trec.nist.gov/data/misinfo2020.html)) and are provided as `XML` files using the following format:
